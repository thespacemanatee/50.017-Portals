...
namespace StarterAssets
{
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        static void ResetThirdPersonControllerArmature()
        {
            ...
            if (player == null)
            {
                if (TryLocatePrefab(PlayerArmaturePrefabName, null, new[] { typeof(ThirdPersonController), typeof(PlayerActionsInputs) }, out GameObject prefab, out string _))
                {
        ...
        static void ResetThirdPersonControllerCapsule()
        {
            ...
            if (player == null)
            {
                if (TryLocatePrefab(PlayerCapsulePrefabName, null, new[] { typeof(ThirdPersonController), typeof(PlayerActionsInputs) }, out GameObject prefab, out string _))
                {
                    HandleInstantiatingPrefab(prefab, out playerGameObject);
                }
                else
        ...
        {
            if (TryLocatePrefab(PlayerArmaturePrefabName, null, new[] { typeof(ThirdPersonController), typeof(PlayerActionsInputs) }, out GameObject _, out string prefabPath))
            {
